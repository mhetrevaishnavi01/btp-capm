...
context CDSViews {
    ...
    define view![POWorklist] as //![] because to put name as it is otherwise converts to capital
    ...
    define view![ProductValueHelp] as //help view
    ...
    mixin{
        //View on view
        PO_ORDER: Association[*] to ItemView on PO_ORDER.ProductId = $projection.ProductId //projection is saying select column productid .//it is inner njoin
    } into {
    ...
    define view CProductValuesView as //aggregation
